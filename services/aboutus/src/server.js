...
const db = mysql.createPool({ // Using a pool is better for concurrent requests
    host: 'localhost',
    user: 'root',
    password: '1234567890', // <<< IMPORTANT: Replace with your actual MySQL root password
    database: 'Informations', // Connecting to the 'Informations' database
