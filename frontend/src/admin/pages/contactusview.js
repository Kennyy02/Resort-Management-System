...
    setLoading(true);
    try {
      // FIX: Use the correct environment variable name: REACT_APP_CONTACTUS_API
...
                    <td>{msg.email}</td>
                    <td>{msg.message}</td>
                    {/* The Date is now correctly formatted because the backend sends a proper Date object */}
