...
    const navigate = useNavigate();
    ...
    // Use useCallback for handler functions for better performance/stability
    ...
    // 1. Filtering must happen BEFORE the return, using the defined 'sortedServices' variable.
...
    const cottages = sortedServices.filter(service => service.type === 'cottage');
    ...
                                    className="book-now-button"
                                    // 2. Call the defined function here
